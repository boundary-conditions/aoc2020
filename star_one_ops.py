...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  1 06:48:45 2020
...
expense_report = [int(i) for i in number_strings]

for first_item in range(len(expense_report)):
    for second_item in range(len(expense_report)):
        if first_item == second_item:
            continue
        elif (expense_report[first_item] + expense_report[second_item]) == 2020:
            print(f"{expense_report[first_item]}, {expense_report[second_item]}")
            product_of_two_sums = expense_report[first_item] * expense_report[second_item]
            break
print(product_of_two_sums)

for first_item in range(len(expense_report)):
    for second_item in range(len(expense_report)):
        for third_item in range(len(expense_report)):
            if first_item == second_item or first_item == third_item or second_item == third_item:
                continue
            elif (expense_report[first_item] + expense_report[second_item] + expense_report[third_item]) == 2020:
                print(f"{expense_report[first_item]}, {expense_report[second_item]}, {expense_report[third_item]}")
                product_of_three_sums = expense_report[first_item] * expense_report[second_item] * expense_report[third_item]
                break
print(product_of_three_sums)
